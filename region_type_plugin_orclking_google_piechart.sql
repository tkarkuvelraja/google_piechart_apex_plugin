...
--   Date and Time:   18:16 Thursday June 3, 2021
...
'FUNCTION RENDER_GOOGLE_PIECHART (',
...
'  l_chart_title VARCHAR2(60);',
'  l_is_chart_3d VARCHAR2(5); --true or false',
'  l_data CLOB;',
'BEGIN',
...
'    APEX_JAVASCRIPT.ADD_LIBRARY(P_NAME => ''orclking.google.piechart'', P_DIRECTORY => P_PLUGIN.FILE_PREFIX, P_VERSION => NULL, P_SKIP_EXTENSION => FALSE);',
'',
...
'   ',
'    sys.htp.p(''<div id="piechart_div_''||l_region||''" style="width: 500px; height: 300px;"></div>'');',
'',
'    sys.htp.p(''<div class="piechart-data-''||l_region||''" style="display: none;">''||l_data||''</div>'');',
'    ',
'    APEX_JAVASCRIPT.ADD_ONLOAD_CODE(P_CODE => ''google.charts.load(''''current'''', {''''packages'''': [''''corechart'''']});'');',
'    APEX_JAVASCRIPT.ADD_ONLOAD_CODE(P_CODE => ''google.charts.setOnLoadCallback(function () {drawPieChart(''''''||l_region||'''''',''''''||l_chart_width||'''''',''''''||l_chart_height||'''''',''''''||l_chart_title||'''''',''''''||l_is_chart_3d||'''''')});'');',
'',
'    RETURN NULL;',
'',
...
,p_about_url=>'https://github.com/tkarkuvelraja/google-pie-Chart'
,p_files_version=>9
);
